 ...
 */
@Entity
@Table(name="\"CSSNG_TURF_Vendor_Upload_Template\"")
public class TurfVendorEnmt_Tmplate {
    ...
    public static final Model.Finder<Integer, TurfVendorEnmt_Tmplate> find = new Model.Finder<>(TurfVendorEnmt_Tmplate.class);
}
